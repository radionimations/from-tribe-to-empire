...
const HISTORICAL_EVENTS = [
  ...
  { year: 2090, civ: { name: "Mars Colony Authority", lat: 28.4, lon: -80.6, color: "#c84a3a" },
    message: "First permanent Mars colony - the Mars Colony Authority opens an Earth-side seat at Cape Canaveral" },
  { year: 2095, type: "alliance", a: "USA", b: "Mars Colony Authority",
    message: "Outer Space Charter - the USA and Mars Colony Authority sign a perpetual partnership" },
  { year: 2105, civ: { name: "Lunar Republic", lat: 32.9, lon: -106.5, color: "#a89678" },
    message: "Lunar settlements declare a Lunar Republic - liaison office in Las Cruces" },
